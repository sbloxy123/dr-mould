...
export default function Causes() {
  return (
    <article data-slot="causes" id="causes" className="flex flex-col gap-4 lg:gap-[22px]">
      ...
      <div data-slot="causes-grid" className="grid grid-cols-2 gap-2.5 lg:gap-4 lg:pt-1.5">
