...
export default function CtaBand({ title, body }: CtaBandProps) {
  return (
    <Container data-slot="cta-band" className="mb-12 lg:mb-[104px]">
      <Reveal>
        <section data-slot="cta-band-panel" className="flex flex-col gap-3.5 rounded-[22px] bg-forest-700 px-5 py-7 lg:flex-row lg:items-center lg:justify-between lg:gap-10 lg:rounded-[28px] lg:px-16 lg:py-14">
          <div data-slot="cta-band-text" className="flex flex-col gap-3.5 lg:gap-2.5">
          ...
          <div data-slot="cta-band-actions" className="flex shrink-0 flex-col gap-3 lg:flex-row">
            <Button
              href="/contact"
              variant="on-dark"
